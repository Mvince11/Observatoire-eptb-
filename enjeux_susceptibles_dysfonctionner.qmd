...
# batiments <- readRDS("layers/batiments.rds")
# st_write(batiments, "layers/batiments_vienne_clain.geojson", driver = "GeoJSON")
```
...
# library(jsonlite)
# 
# batiments <- st_read("layers/bati_vienne.geojson")
# 
# batiments$hauteur <- as.numeric(batiments$nb_etages) * 3  # approx. 3m par étage
# 
# batiments_hauteurs <- st_write(batiments, "layers/batiments_hauteur.geojson", driver = "GeoJSON")
        ...
        new maplibregl.Popup({closeButton: false})
         ...
         <div style="text-align:center; font-family:sans-serif; font-size:16px;">
            ...
            <div style="margin-top:10px;">
              <strong style="font-size:1.1em;"><i class="bi bi-building"></i> Nombre d’enjeux utiles à la gestion de crise susceptibles de dysfonctionner :</strong> ${dommages}
            </div>
          </div>
         `;
      });
