...
/* Pulse sur active */
.tab-btn.active i {
  animation: slowRotate 12s linear infinite, pulseIcon 1.2s ease infinite;
  color: white;
  opacity: 1;
}
...
<div class="tabset">
  ...
  <div class="tab-buttons">
    ...
    <button class="tab-btn" data-tab="tab4" style="display:none;">
    <i class="bi bi-building"></i>Données de la commune
    </button> 
    <button class="tab-btn" data-tab="tab5" style="display:none;">
     <i class="bi bi-table"></i>Tableau de données
     </button>
    <button class="tab-btn" data-tab="tab6">
     <i class="bi bi-bar-chart"></i>Graphiques
     </button>
    <button class="tab-btn" data-tab="tab2" style="display:none;">
    <i class="bi bi-info-circle"></i>Informations relatives à l'indicateur
    </button>
    <button class="tab-btn" data-tab="tab3" style="display:none;">
    <i class="bi bi-box"></i>Bâtiments en 3D : Mode d'emploi
    </button>
  </div>
...
map = {
  ...
  maxzoom: 19
    ...
    // --- Conteneur global des fonds de plan ---
    const fondListDiv = document.createElement("div");
    fondListDiv.id = "fondListDiv";
    fondListDiv.style.display = "flex";
    fondListDiv.style.flexDirection = "column";
    fondListDiv.style.padding = "10px";
    fondListDiv.style.gap = "15px";
    fondListDiv.style.textAlign = "center";
    
    window.fondListDiv = fondListDiv;
    ...
    item.addEventListener("click", () => {
      ...
      document.querySelectorAll(".fond-item")
