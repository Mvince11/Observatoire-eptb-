...
map = {
  ...
  maxzoom: 19
    ...
    const fondOptions = [
      {
        ...
        label: "Plan",
        img: "Images/OSM.jpg",
        apply: () => toggleStyle(false)   // ton style normal
      },
      {
        id: "ortho",
        label: "Photos aériennes",
        img: "Images/ORTHOPHOTOS.jpg",
        apply: () => toggleStyle(true)    // ton orthophoto
      }
    ];
    ...
    rightTabs.innerHTML = `
      ...
      <button class="tool-btn" data-tool="mesures"><i class="bi bi-rulers"></i></button>
      <button class="tool-btn" data-tool="dessin"><i class="bi bi-pencil"></i></button>
    `;
...
::: {style="width:100%; max-width:1000px; margin: 0 auto; padding: 20px 0;"}
