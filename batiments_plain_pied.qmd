...
resources:
  ...
  - layers/batiments_hauteur.pmtiles
  - layers/zi_cartino2d.pmtiles
  - layers/zi_ppri_azi.pmtiles
  - layers/ruissellement_cartino2d.pmtiles
  # - layers/ruissellement_exzeco.pmtiles
  - layers/communes_zone_papi.pmtiles
  - layers/cours_d_eau.pmtiles
  - layers/indicateurs.geojson
  - tableau_commune.html
  - Images/*.jpg
  - Images/logo/*.jpg
  - Images/logo/*.png
...
include-in-header:
  text: |
    ...
    <script src="js/tabs_dissapear.js" type="text/javascript"></script>
...
map = {
  ...
  maxzoom: 19
    ...
    const layersData = [
      ...
      {
        pmtiles: true,
        source: "zoneinondable2d",
        sourceLayer: "zi_cartino2d",
        type: "fill",
        id: "zoneinondable2dLayer",
        color: "#b4c3ef",
        opacity: 0.5,
        layout: {
          visibility: "visible"
      ...
      {
        pmtiles: true,
        source: "zoneinondableazi",
        sourceLayer: "zi_ppri_azi",
        type: "fill",
        id: "zoneinondableaziLayer",
        color: "#b4c3ef",
        opacity: 0.5,
        layout: {
          visibility: "none"
    ...
    // Créer le conteneur
        ...
        const isPopVisible = legend.style.display !== "none";
        const isBatVisible = batimentLegend.style.display !== "none";
      
        // Cas 1 : les deux légendes sont visibles
        if (isPopVisible && isBatVisible) {
          legend.style.top = "70%";          // la première remonte
          batimentLegend.style.top = "82%";  // la seconde descend
        }
      
        // Cas 2 : seule la légende population est visible
        else if (isPopVisible && !isBatVisible) {
          legend.style.top = "82%";          // reprend sa place normale
        }
      
        // Cas 3 : seule la légende bâtiment est visible
        else if (!isPopVisible && isBatVisible) {
          batimentLegend.style.top = "82%";  // reprend sa place normale
        }
      
        // Cas 4 : aucune légende visible
        else {
          // rien à faire
        }
      }
        ...
        map.addSource("zoneinondable2d", {
         ...
         const ZONE_PM_azi = "layers/zi_ppri_azi.pmtiles";

        // Reconstruit proprement l'URL absolue HTTP/HTTPS
        const zoneAbsoluteaziUrl = new URL(ZONE_PM_azi, window.location.href).href;
        
        map.addSource("zoneinondableazi", {
          type: "vector",
        ...
        const ZONE_PM_cdeau = "layers/cours_d_eau.pmtiles";
  ...
  // ==========================================================
    ...
    const aliasLayerIds = {
      ...
      zoneinondable2dLayer: 'Zonage Inondable par modélisation Cartino 2D',
      zoneinondableaziLayer: 'Zonage Inondable par modélisation PPRI AZI',
    ...
    .map(layer => layer.id)
    .filter(id => id !== "indicateurs12aLayer");
...
fondListDiv.addEventListener("click", (e) => {
  ...
  // Recherche du fond correspondant
  ...
  // On conserve le sélecteur ouvert
  fondListDiv.classList.add("hover-active");
});
    ...
    rightTabs.innerHTML = `
     ...
     <!-- <button class="tool-btn" data-tool="fond"><i class="bi bi-image"></i></button> -->
      ...
      <button class="tool-btn" data-tool="graphique"><i class="bi bi-bar-chart"></i></button>
    `;
   ...
   const rightTabsToggle = document.createElement("div");
    ...
    <!-- rightTabsToggle.innerHTML = ` -->
      <!-- <i class="bi bi-chevron-right" style="font-size:18px; color:#2A3B4D;"></i> -->
    <!-- `; -->
    ...
    //window.legendDiv = legendDiv;-->
          ...
          // Bâtiments 3D
          const batiment3dDiv= document.createElement("div");
          batiment3dDiv.id = "batiment3dDiv";
          batiment3dDiv.style.padding = "10px";
          batiment3dDiv.style.fontFamily = "Arial";
          batiment3dDiv.style.fontSize = "14px";
          batiment3dDiv.style.lineHeight = "1.4";
          
          window.batimment3dDiv = batiment3dDiv;
    ...
    document.getElementById('orthoCheckbox').addEventListener('change', function (e) {
      ...
      const toggleContainer = document.createElement("div");
        toggleContainer.id = "toggleInondableContainer";
        toggleContainer.innerHTML = `<span>Affichage de l'indicateur</span>`;
        map.getContainer().appendChild(toggleContainer);
        
        // --- Bouton ---
        const toggleBtn = document.createElement("div");
        toggleBtn.id = "toggleInondableBtn";
        toggleBtn.innerHTML = `<i class="bi bi-water"></i>`;
        toggleContainer.appendChild(toggleBtn);
        
        // --- État initial ---
        let inondableVisible = map.getLayoutProperty("indicateurs12aLayer", "visibility") !== "none";
        
        // --- Fonction de toggle ---
        function toggleInondable() {
          inondableVisible = !inondableVisible;
        
          map.setLayoutProperty(
            "indicateurs12aLayer",
            "visibility",
            inondableVisible ? "visible" : "none"
          );
        
          toggleBtn.classList.toggle("active", inondableVisible);
        }
        
        // --- Clic ---
        toggleBtn.addEventListener("click", toggleInondable);
...
Maintenez enfoncé le bouton droit de la souris sur ce symbole <img src="Images/bouton_inclinaison.jpg" style="margin-bottom:auto;"/> et déplacez le pour incliner le point de vue ou faire tourner la carte.
...
![Bâtiments 3D](Images/batiments_3d.jpg){fig-align="center" width="100%"}
:::
...
widget <- reactable(indicateur_s12a,
  filterable = TRUE,
  striped = TRUE,
  sortable = TRUE,
  resizable = TRUE,
